...
namespace DiscordLite_API.Migrations
{
    ...
    [Migration("20260617142719_AddInviteCodeToServe")]
    partial class AddInviteCodeToServe
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DiscordLite_API.Model.ChannelMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DiscordLite_API.Model.ChannelMessage", b =>
                {
                    b.HasOne("DiscordLite_API.Model.ServerChannel", "Channel")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("DiscordLite_API.Model.Server", b =>
                {
                    b.HasOne("DiscordLite_API.Model.User", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("DiscordLite_API.Model.ServerChannel", b =>
                {
                    b.HasOne("DiscordLite_API.Model.Server", "Server")
                        .WithMany("Channels")
            ...
            modelBuilder.Entity("DiscordLite_API.Model.ServerMember", b =>
                {
                    ...
                    b.HasOne("DiscordLite_API.Model.User", "User")
                        .WithMany()
