...
namespace DiscordLite_WEB.Extensions
{
    public static class MultipartFormDataExtension
    {
        public static MultipartFormDataContent ToMultipartFromData(this object obj)
        {
